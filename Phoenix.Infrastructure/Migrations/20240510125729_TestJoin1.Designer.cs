...
namespace Phoenix.Infrastructure.Migrations
{
    ...
    [Migration("20240510125729_TestJoin1")]
    partial class TestJoin1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Phoenix.Domain.SampleDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SampleHeaderId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("SampleHeaderId");

                    b.ToTable("SampleDetail");
                });

            modelBuilder.Entity("Phoenix.Domain.SampleHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Phoenix.Domain.SampleDetail", b =>
                {
                    b.HasOne("Phoenix.Domain.SampleHeader", "SampleHeader")
                        .WithMany("SampleDetails")
                        .HasForeignKey("SampleHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SampleHeader");
                });
